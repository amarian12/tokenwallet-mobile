...
export class WalletPage implements OnInit {
  ...
  constructor(private logger: LogService,
             ...
             ngOnInit() {
               ...
               this.logger.info('### Wallet Page: currentWallet: ' + JSON.stringify(this.currentWalletObject));
               // check if wallet is open else open it
               this.walletService.openWalletSubject.subscribe( result => {
                 if (result === AppConstants.KEY_INIT) {
                   this.logger.debug('### Wallet Page: Wallet INIT');
                   ...
                   this.logger.debug('### Wallet Page: Wallet OPENING');
                 } else if (result === AppConstants.KEY_LOADED) {
                   this.logger.debug('### Wallet Page: Wallet LOADED');
                   ...
                   this.logger.debug('### Wallet Page: Wallet CLOSED');
             ...
             doBalanceUpdate() {
               ...
               this.logger.debug('### Wallet Page: - Wallet Balance: ' + this.walletBalance);
